...
#client = LineClient()
client = LineClient(id='mukhamadfahrur@gmail.com', passwd='hamzah1997')
                    ...
                    if msg.contentType == 0:
                        if msg.toType == 2:
                            ...
                            if text.lower() == 'me':
                                ...
                                client.sendText(receiver, "Total Jones :"+str(jml))
                    ...
                    if cctv['cyduk'][op.param1]==True:
                        if op.param1 in cctv['point']:
                            ...
                            if Name in cctv['sidermem'][op.param1]:
                                ...
                                pref=['hai kak','jangan cuman ngintip! entar bintitan loh kak']
